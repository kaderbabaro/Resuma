...
class _AppDrawerState extends State<AppDrawer> {
  ...
  UserPlan get _plan => CreditService().currentPlan;

  // ✅ Badge plan dynamique en anglais
  Widget _planBadge() {
    switch (_plan) {
      case UserPlan.pro:
        return Container(
      ...
      case UserPlan.basic:
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border:
            Border.all(color: const Color(0xFF4A90E2).withOpacity(0.6)),
          ),
          child: const Row(
            mainAxisSize: MainAxisSize.min,
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _planBadge(), // ✅ auto-rebuild via notifier
                      ],
                    ),
                  ),
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      // Pas besoin de .then() — le notifier rebuild automatiquement
                    },
                    child: Container(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  _plan == UserPlan.free
                                      ? "Unlimited summaries from €2.99/mo"
                                      : _plan == UserPlan.pro
                                      ? "Pro plan active ✓"
                                      : "Basic plan active ✓",
                                  style: GoogleFonts.inter(
